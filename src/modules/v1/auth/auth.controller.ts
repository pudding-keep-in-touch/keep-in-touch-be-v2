...
export class AuthController {
  ...
  @GenerateSwaggerApiDoc({
    summary: '구글 로그인',
    description: 'Swagger에서 테스트 할 수 없습니다. localhost:3000/v1/auth/google/login 으로 테스트 해주세요.',
  })
  async googleLogin() {
  ...
  @GenerateSwaggerApiDoc({
    summary: '구글 로그인 콜백',
    description: 'Swagger에서 테스트 할 수 없습니다. localhost:3000/v1/auth/google/callback 으로 테스트 해주세요.',
